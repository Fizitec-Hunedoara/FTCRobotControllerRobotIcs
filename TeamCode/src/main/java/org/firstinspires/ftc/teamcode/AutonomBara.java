...
public class AutonomBara extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence ts7 = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                ...
                .lineToLinearHeading(new Pose2d(61, -41, Math.toRadians(270)),SampleMecanumDrive.getVelocityConstraint(85.0, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(85.0)
                )
        ...
        TrajectorySequence ts = drive.trajectorySequenceBuilder(startPose)
                .lineToLinearHeading(new Pose2d(-8, -28, Math.toRadians(270)),SampleMecanumDrive.getVelocityConstraint(85.0, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(85.0)
                )
                .addTemporalMarker(0, 0, () -> new Thread(() -> {
                    func.kdf_auto(300);
        ...
        if(func.getBatteryVoltage() > 15.5) {
        ...
        TrajectorySequence ts4 = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(42, -62, Math.toRadians(270)),SampleMecanumDrive.getVelocityConstraint(85.0, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(85.0)
                )
                .addTemporalMarker(0, 0, () -> new Thread(() -> {
                    func.gardtogheara_auto();
        ...
        TrajectorySequence ts5 = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(0, -26, Math.toRadians(270)),SampleMecanumDrive.getVelocityConstraint(85.0, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(85.0)
                )
                .addTemporalMarker(0.0, 0, () -> new Thread(() -> {
                    func.ghearapozbara_auto(false);
                    func.kdf_auto(450);
                    func.puspebara_auto();
                }).start())
        ...
        drive.followTrajectorySequence(ts4);
        TrajectorySequence ts6 = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(3, -26, Math.toRadians(270)),SampleMecanumDrive.getVelocityConstraint(85.0, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(85.0)
                )
                .addTemporalMarker(0.0, 0, () -> new Thread(() -> {
                    func.ghearapozbara_auto(false);
        ...
        drive.followTrajectorySequence(ts4);
        TrajectorySequence ts8 = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(-4, -26, Math.toRadians(270)),SampleMecanumDrive.getVelocityConstraint(85.0, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(85.0)
                )
                .addTemporalMarker(0.0, 0, () -> new Thread(() -> {
                    func.ghearapozbara_auto(false);
