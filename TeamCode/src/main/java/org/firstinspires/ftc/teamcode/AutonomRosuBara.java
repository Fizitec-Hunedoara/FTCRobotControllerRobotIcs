...
public class AutonomRosuBara extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d startPose = new Pose2d(15.0393700787, -59.2236220472, Math.toRadians(270));
        drive.setPoseEstimate(startPose);
        waitForStart();
        Systems.start();
        TrajectorySequence ts = drive.trajectorySequenceBuilder(startPose)
                .lineToLinearHeading(new Pose2d(-6,-26,Math.toRadians(270)))
        ...
        TrajectorySequence ts2 = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                ...
                .lineToLinearHeading(new Pose2d(53, -30, Math.toRadians(270)))
                .lineToLinearHeading(new Pose2d(53, -52, Math.toRadians(270)))
                .build();
        ...
        TrajectorySequence ts5 = drive.trajectorySequenceBuilder(startPose)
                .lineToLinearHeading(new Pose2d(4,-26,Math.toRadians(270)))
                .addTemporalMarker(0.5, 0, () -> new Thread(() -> {
                    func.putSpecimenOnBar_auto();
                }).start())
                .build();
