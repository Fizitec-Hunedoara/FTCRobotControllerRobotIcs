...
@Autonomous
public class Autonomnou extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence ts4 = drive.trajectorySequenceBuilder(startPose)
                .lineToLinearHeading(new Pose2d(43,-63,Math.toRadians(270)),SampleMecanumDrive.getVelocityConstraint(80.0, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(80.0)
                )
                .build();
