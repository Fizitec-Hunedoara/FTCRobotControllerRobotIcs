...
public class Conf {
    ...
    public static double pstatic = 0.007, istatic = 6e-9, dstatic = 0.007;
    public static double pretard =0.005 , iretard = 0.0000005, dretard = 0.0008;
    ...
    public double pslider = 0.001, islider = 0.0, dslider = 0.0;
